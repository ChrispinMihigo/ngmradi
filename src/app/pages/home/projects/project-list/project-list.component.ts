  ...
  template: `
    <main>
      ...
      >
        ...
        <mat-divider />
        <mat-card-content>
          {{ formatdDate(project.createdAt) | date : 'fullDate' }}
        </mat-card-content>
      </mat-card>
      }@empty {
      <h3 align="center" style="width: 100%;">
        Oups! Aucun projet à afficher! <br />
        commencer par ajouter un nouveau projet ou être ajouter collaborateur
        dans un projet
      </h3>
      }
    </main>
...
export class ProjectListComponent implements OnInit, OnDestroy {
  ...
  // formatdDate = (t?: Timestamp) => (t ? this.fs.formatedTimestamp(t) : '');
